    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <% if (employeeSession != null) {
                String jobId = employeeSession.getJob().getJobId();
            %>

            <% if (jobId.equals("AD_PRES") || jobId.equals("AD_VP") || (!jobId.equals("IT_PROG") && !jobId.equals("ST_CLERK"))) { %>
            ...
            <% if (jobId.equals("AD_PRES") || jobId.equals("IT_PROG") || (!jobId.equals("AD_VP") && !jobId.equals("ST_CLERK"))) { %>
            ...
            <% if (jobId.equals("AD_PRES") || jobId.equals("ST_CLERK") || (!jobId.equals("AD_VP") && !jobId.equals("IT_PROG"))) { %>
            <li class="nav-item <%=currentPage.equals("emp") ? "active" : ""%>">
                <a class="nav-link" href="<%=request.getContextPath()%>/EmployeeServlet">Employees</a>
            </li>
            <% } %>

            <% if (!jobId.equals("ST_CLERK") && !jobId.equals("IT_PROG")) { %>
