        ...
        <div class='container'>
            ...
            <div class="row mb-5 mt-4">
                ...
                <div class="col-lg-6 my-auto text-lg-right">
                    <a href="<%= request.getContextPath()%>/LocationServlet?action=formCrear" class="btn btn-primary">Crear Ubicación</a>
                </div>
            </div>
            <table class="table">
                <tr>
                ...
                <tr>
                    ...
                    <td><%=location.getPostalCode()==null?"--":location.getPostalCode() %></td>
                    <td><%=location.getCity() %></td>
                    <td><%=location.getStateProvince()==null?"--":location.getStateProvince() %></td>
